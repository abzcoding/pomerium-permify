module github.com/abzcoding/pomerium-permify
...
require (
	...
	github.com/pomerium/pomerium v0.0.0
...
require (
	...
	charm.land/bubbletea/v2 v2.0.0-rc.2.0.20251217174709-64b15728bac9 // indirect
	...
	github.com/pomerium/datasource v0.18.2-0.20260513141340-e0e123819aa8 // indirect
...
// Use the sibling pomerium checkout that this plugin is being developed
// against. Operators consuming a tagged release should remove the replace.
replace github.com/pomerium/pomerium => ../../pomerium/pomerium
